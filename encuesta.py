...
class Encuesta(tk.Tk):
    ...
    def inicializarMain(self):
        ...
        frameMain = tk.Frame(self, bd=8, relief='groove', bg='#d9d9d9')
        frameMain.grid(row=1, column=1, padx=10, pady=10)
        # Nombre
        nombreLabel = tk.Label(frameMain, text='Nombre:')
        nombreLabel.grid(row=0, column=0, sticky=tk.W)
        self.nombreEntry = tk.Entry(frameMain, width=20)
        self.nombreEntry.grid(row=0, column=1)
        # Edad
        edadLabel = tk.Label(frameMain, text='Edad:')
        edadLabel.grid(row=1, column=0, sticky=tk.W)
        self.edadEntry = tk.Entry(frameMain, width=20)
        self.edadEntry.grid(row=1, column=1)
        # mes
        mesLabel = tk.Label(frameMain, text='Mes:')
        mesLabel.grid(row=2, column=0, sticky=tk.W)
        self.mesEntry = tk.Entry(frameMain, width=20)
        self.mesEntry.grid(row=2, column=1)
        # Email
        emailLabel = tk.Label(frameMain, text='Email:')
        emailLabel.grid(row=3, column=0, sticky=tk.W)
        self.emailEntry = tk.Entry(frameMain, width=20)
        self.emailEntry.grid(row=3, column=1)
        # residencia
        residenciaLabel = tk.Label(frameMain, text='Residencia:')
        residenciaLabel.grid(row=4, column=0, sticky=tk.W)
        self.residenciaEntry = tk.Entry(frameMain, width=20)
        self.residenciaEntry.grid(row=4, column=1)
        # pago
        pagoLabel = tk.Label(frameMain, text='Pago:')
        pagoLabel.grid(row=5, column=0, sticky=tk.W)
        self.pagoCombox = ttk.Combobox(frameMain, width=20)
        ...
        # experiencia
        experienciaLabel = tk.Label(frameMain, text='Experiencia:')
        experienciaLabel.grid(row=6, column=0, sticky=tk.W)
        self.experienciaEntry = tk.Entry(frameMain, width=20)
        self.experienciaEntry.grid(row=6, column=1)
        # compra
        compraLabel = tk.Label(frameMain, text='Compra:')
        compraLabel.grid(row=7, column=0, sticky=tk.W)
        self.compraEntry = tk.Entry(frameMain, width=20)
        self.compraEntry.grid(row=7, column=1)
        # sabor
        saborLabel = tk.Label(frameMain, text='Sabor:')
        saborLabel.grid(row=8, column=0, sticky=tk.W)
        self.saborCombox = ttk.Combobox(frameMain, width=20)
        ...
        # escala
        escalaLabel = tk.Label(frameMain, text='Escala:')
        escalaLabel.grid(row=9, column=0, sticky=tk.W)
        self.escalaEntry = tk.Entry(frameMain, width=20)
        self.escalaEntry.grid(row=9, column=1)
        # botones media moda y mediana
        mediaTituloLabel = tk.Label(frameMain, text='Media:')
        media= tkinter.Label(frameMain, text=c.media())
        mediaTituloLabel.grid(row=1, column=2 )
        media.grid(row=2, column=2)

        modaTituloLabel = tk.Label(frameMain, text='Moda:')
        moda= tkinter.Label(frameMain, text=c.moda())
        modaTituloLabel.grid(row=1, column=3 )
        moda.grid(row=2, column=3)

        medianaTituloLabel = tk.Label(frameMain, text='Mediana:')
        mediana= tkinter.Label(frameMain, text=c.mediana())
